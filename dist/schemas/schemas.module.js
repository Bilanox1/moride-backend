...
let SchemasModule = class SchemasModule {
};
exports.SchemasModule = SchemasModule;
exports.SchemasModule = SchemasModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: user_schema_1.User.name, schema: user_schema_1.UserSchema },
                { name: pharmacy_schema_1.Pharmacy.name, schema: pharmacy_schema_1.PharmacySchema },
